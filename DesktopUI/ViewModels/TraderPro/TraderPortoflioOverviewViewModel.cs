...
{
    public class TraderPortoflioOverviewViewModel: Screen
    {
        ...
        public TraderPortoflioOverviewViewModel(ITradeTransactionEndpoint tradeTransactionEndpoint, ITradePortfolioEndpoint tradePortfolioEndpoint,
            IStockDataEndpoint stockDataEndpoint, IUserAccountEndpoint userAccountEndpoint, ITradeRealizedPLEndpoint tradeRealizedPLEndpoint)
        {
        ...
        private async Task LoadRealizedProfitLoss()
        {
            ...
            var results = await _tradeRealizedPLEndpoint.LoadHistory();
        ...
        private async Task LoadTransactions()
        {
            ...
            var results = await _tradeTransactionEndpoint.LoadTransactions();
            ...
            //load chart
            var transactionChartData = await _tradeTransactionEndpoint.LoadChartData();
