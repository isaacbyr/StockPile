...
{
    public class TraderPortfolioOverviewViewModel: Screen
    {
        ...
        public TraderPortfolioOverviewViewModel(ITradeTransactionEndpoint tradeTransactionEndpoint, ITradePortfolioEndpoint tradePortfolioEndpoint,
